    ...
    int[][][] calculateAnswers(int n) {
        ...
        for (int i = 0; i < permutations.size(); i++) {
            for (int j = 0; j <= i; j++) {
                ...
                if (answers[answers.length / 2 + r] == null) {
                    answers[answers.length / 2 + r] = new int[][]{extended.get(i), extended.get(j)};
                }
                if (answers[answers.length / 2 - r] == null) {
                    answers[answers.length / 2 - r] = new int[][]{extended.get(j), extended.get(i)};
                }
            }
        }
        return answers;
